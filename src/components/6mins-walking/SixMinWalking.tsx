                ...
                <div className='walking_top_container'>
                    <div className='walking_top_container-left'>
                        ...
                        <div className='walking_top_container-left-items-item'>
                            <img src={checkSquare} alt=""/>
                            <div>
                                Выберите место с заранее известным метражом (например длина комнатв вдоль одной из стен,
                                по
                                коридору)
                            </div>
                        </div>
                        <div className='walking_top_container-left-items-item'>
                            <img src={checkSquare} alt=""/>
                            <div>
                                Затем, в течении 6 минут выполнения теста ( ходьба по коридору, вдоль стены по комнате
                                туда
                        ...
                        <div className='walking_top_container-left-items-item'>
                            <img src={checkSquare} alt=""/>
                            <div>
                                Затем присесть и отдохнуть в течении 10 минут при этом еще раз подсчитав ЧСС и измерив
                                АД на
                ...
                <div className='walking_bottom_container'>
                    <div className='walking_bottom_container_distance'>
                        <Form.Item
                            ...
                            rules={[{required: true, message: 'Введите пройденное расстояние!'}]}
                            name="distance"
                        >
                            <Input type='number'/>
                        </Form.Item>
                    ...
                    <div className='walking_bottom_container_tables'>
                        ...
                        <div>
                            ...
                            <div>
                                <Button type="primary" danger> Завершить</Button>
                            </div>
                        </div>
                    </div>
                </div>
